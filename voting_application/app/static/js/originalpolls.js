    ...
    <div>
      <form id="poll_form" className="form-signin" onSubmit={this.handleSubmit}>
        ...
        <div className="row form-group">
          <button className="btn btn-lg btn-success btn-block" onClick={this.handleOptionAdd}>Add Candidate</button>
          <button className="btn btn-lg btn-success btn-block" type="submit">Save Election</button>
        </div>
        <br />
      </form>
